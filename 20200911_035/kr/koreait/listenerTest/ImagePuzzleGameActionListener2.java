...
public class ImagePuzzleGameActionListener2 extends JFrame implements ActionListener {
	...
	public ImagePuzzleGameActionListener2() {
		setTitle("ImagePuzzleGame");
		setBounds(1000, 100, 400, 500);
		
//		퍼즐에 사용할 이미지의 이름을 저장한 배열을 선언한다.
...
//		InputDialog에서 퍼즐에 사용할 이미지를 선택한다.
	...
	public static void main(String[] args) {
		...
		ImagePuzzleGameActionListener2 window = new ImagePuzzleGameActionListener2();
